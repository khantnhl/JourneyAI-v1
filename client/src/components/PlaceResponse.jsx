...
async function placeDetail(placeId) {
    const fetchDetail = async () => {
        try {
            const response = await fetch(`https://journey-ai-v1-server.vercel.app/api/place/place_detail`, {
                method: "POST",
                headers: {
...
async function placeSearch(location) {
    const fetchPlaceDetail = async () => {
        try {
            const response = await fetch(`https://journey-ai-v1-server.vercel.app/api/place/place_search`, {
                method: "POST",
                headers: {
                    "Content-type": "application/json"
                },
...
async function placePhoto(location) {
    ...
    const fetchPhotoData = async () => {
        try {
            const response = await fetch(`https://journey-ai-v1-server.vercel.app/api/place/photo_search`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json"
                },
